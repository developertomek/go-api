...
import (
	...
	"github.com/developertomek/go-api/internal/middleware"
	"github.com/developertomek/go-api/internal/store"
	"github.com/developertomek/go-api/internal/utils"
)
...
func NewWorkoutHandler(workkoutStore store.WorkoutStore, logger *log.Logger) *WorkoutHandler {
	return &WorkoutHandler{
		workoutStore: workkoutStore,
		logger:       logger,
	}
}
...
func (wh *WorkoutHandler) HandleCreateWorkout(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		wh.logger.Printf("ERROR decodingCreatedWorkout: %v", err)
...
func (wh *WorkoutHandler) HandleUpdateWorkoutByID(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		wh.logger.Printf("ERROR: decodingUpdateRrequest %v", err)
